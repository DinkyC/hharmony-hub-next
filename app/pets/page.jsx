      ...
      <section className="flex flex-col items-center justify-center py-12">
        <div className="mt-11  w-[86vw] shadow rounded-lg bg-gray-300 text-center">
          ...
          <p className="my-4 mx-9 font-medium leading-8">
            Explore our selection of unique pet products across multiple
            categories. We hope to provide your dogs and cats with the treats
            they need and want.
          </p>
        </div>
        <Container classNames="grid grid-cols-1 lg:grid-cols-2 content-center items-center justify-items-center justify-evenly pt-4">
          ...
          <Card
            title="Catnip"
            desc={
              "Indulge your cat with this premium Catnip, crafted from the finest, all-natural herbs for a truly 'elevated' experience."
            }
          ...
          <Card
            title="Cat Food"
            desc={
              "Expertly formulated for cats, our recipe offers a natural and balanced approach to enhancing your cats health."
            }
          ...
          <Card
            title="Dog Food"
            desc={
              "Expertly crafted for dogs, our formula provides a natural and balanced approach to boosting your dog's health."
            }
