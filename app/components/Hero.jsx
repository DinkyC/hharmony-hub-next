    ...
    <div ref={ref} className="py-20 lg:py-0 hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="lg:mr-10 text-center lg:w-3/5 2xl:w-2/5 2xl:mr-28 lg:text-start">
          <h1
            className={`transition-opacity duration-2500 ${inView ? "opacity-100" : "opacity-0"} py-6 text-3xl sm:text-6xl font-bold leading-relaxed`}
            style={{ transitionDelay: `0.4s` }}
          >
            <p className={`${permanentMarker.className} pb-4`}>
              High Times<sup className="p-2 text-[1.5rem]">™</sup>
            </p>
            Products!
          </h1>
          <p
          ...
          >
            Discover High Times<sup className=" text-[.9rem]">™</sup>{" "}
            branded products like you&apos;ve never seen them before, offering
            an unparalleled mix of quirky charm and wholesome goodness for your
            ultimate chill.
          </p>
          <a href="#form">
            <button className="text-lg bg-red-400 hover:bg-red-600 hover:text-white btn btn-wide glass">
              Contact Us
            </button>
          </a>
        </div>
