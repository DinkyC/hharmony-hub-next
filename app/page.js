  ...
  return (
    <>
      ...
      <Product
        ...
        descr={
          "Crafted specifically for cats to provide a natural and holistic approach to their well-being. " +
      ...
      <Product
        ...
        descr={
          "Crafted specifically for dogs to provide a natural and holistic approach to their well-being. " +
          "These chews offer a delicious and calming experience, " +
          "promoting relaxation and overall health for your furry friend."
        }
        bene1="Calming Effect"
      ...
      <Product
        ...
        descr={
          "Enhance your mezcal with our terpene infusion kit, adding unique, aromatic flavors for a premium experience."
        }
        bene1="Fruity"
        bene2="Smokey"
        bene3="Vivacious"
      ...
      <Product
        ...
        descr={
          "Elevate your whiskey with our terpene infusion kit, creating rich, aromatic profiles for a refined taste."
        }
        bene1="Crisp"
        bene2="Fruity"
        bene3="Bright"
      ...
      <Product
        ...
        title="Mezcal"
        descr={
          "Discover the rich, smoky essence of our handcrafted mezcal, crafted from the finest agave for an authentic and unforgettable taste experience."
        }
        bene1="Floral"
        bene2="Citrusy"
        bene3="Jalapeno"
      ...
      <Product
        ...
        title="Lager (12 Pack)"
        descr={
          "Experience the crisp, refreshing taste of our premium lager beer, brewed to perfection for your ultimate enjoyment."
        }
        bene1="Crisp"
        bene2="Mellow"
        bene3="Malty"
      ...
      <a href="/smoking">
        <button className="text-lg bg-dark-slate btn btn-wide glass">
          More Smoking Products
        </button>
      </a>
      <Divider text="Confectionary Goods" />
      <Product
        brand="High Times™"
        title="Brownie Bites"
        descr={
